...
export default function PokeballAnimation() {
    ...
    useLayoutEffect(() => {
        ...
        return () => {ctx.revert(); document.body.style.overflow = originalOverflow;}
    }, []);

    return (
        <div style={{height: '100%', width: '100%', display: (hideBall ? 'none' : 'flex'), alignItems: 'center', justifyContent: 'center'}}>
            <img
                ref={imgRef}
